...
module.exports = (MongoClient, url) => {
    ...
    app.get("/singin", (req, res) => {
        if (req.query.RESULT === "no") {
            res.render("singInPublic/index", { noteSingIn: "Login failed.  If you have not registered before, you can register with this link:"})
        } else {
            res.render("singInPublic/index", { noteSingIn: ""})
        }
    })
